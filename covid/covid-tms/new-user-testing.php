...
<head>
    ...
    <title>Covid19 Testing Management System | New User Testing</title>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>DOB</label>
                                            <input type="date" class="form-control" max="2007-12-31" id="dob" name="dob" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label>Any Govt Issued ID</label>
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="Aadhaar card / Pancard / Driving License / Voter id" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label>SRF ID</label>
                                            <input type="text" class="form-control" id="SRFid" name="SRFid" placeholder="Enter SRF ID Number" required="true">
                                        </div>
