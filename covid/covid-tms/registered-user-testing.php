            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php if (isset($_POST['search'])) { ?>
                        <h3 align="center" style="color:red">Result againt mobile number "<?php echo $_POST['regmobilenumber']; ?>"</h3>
                        <hr />
                        <?php
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>SRF ID</label>
                                                        <input type="text" class="form-control" id="SRFid" name="SRFidnumber" value="<?php echo $result['SRFIdNo']; ?>" readonly="true">
                                                    </div>
