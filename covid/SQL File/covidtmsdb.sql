...
CREATE TABLE `tblpatients` (
  ...
  `SRFId` varchar(150) DEFAULT NULL,
...
INSERT INTO `tblpatients` (`id`, `FullName`, `MobileNumber`, `DateOfBirth`, `GovtIssuedId`, `SRFId`, `FullAddress`, `State`, `RegistrationDate`) VALUES
